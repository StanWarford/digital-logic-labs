...
{
    [self.pins replaceObjectAtIndex:2 withObject: [[self.pins objectAtIndex:0] OR:[self.pins objectAtIndex:1]]];
    [self.pins replaceObjectAtIndex:5 withObject: [[self.pins objectAtIndex:3] OR:[self.pins objectAtIndex:4]]];
    [self.pins replaceObjectAtIndex:7 withObject: [[self.pins objectAtIndex:8] OR:[self.pins objectAtIndex:9]]];
    [self.pins replaceObjectAtIndex:10 withObject: [[self.pins objectAtIndex:11] OR:[self.pins objectAtIndex:12]]];
}
